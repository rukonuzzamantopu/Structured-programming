...
int main() {
    ...
    switch (choice) {
        ...
        case 2:
            ...
            break;
        case 3:
            printf("\nThis programme is developed by Modabbir Mansur. ");
            printf("It's a simple banck management systame that will help \n us to manage our banck account. \n");
            printf("In some days it will be full time programme. ");
            printf("\nCANNECT WITH US FOR ANY INFORMATION... \nConnect through:14555,53200,01631319163");
            break;
        case 4:
            exit(0);
        default:
...
void account(void) {
    ...
    printf("PASSWORD: ");
    scanf("%s", u1.pass);
    strcpy(u2.password, u1.username);
    for (i = 0; i < 50; i++) {
        ch = getchar();
        if (ch != '\n') {
            password[i] = ch;
